...
import { Calendar, Mail, Phone, MapPin, Car, Wrench, Key } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {services.map((service) => (
                <li key={service.id}>
                  <Link
                    to={`/professionnels?categorie=${service.id}`}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/inscription" className="text-sm hover:text-white transition-colors">
                  Devenir professionnel
                </Link>
              </li>
              <li>
                <Link to="/comment-ca-marche" className="text-sm hover:text-white transition-colors">
                  Comment ça marche ?
                </Link>
              </li>
              <li>
                <Link to="/aide" className="text-sm hover:text-white transition-colors">
                  Centre d'aide
                </Link>
              </li>
              <li>
                <Link to="/avis" className="text-sm hover:text-white transition-colors">
                  Avis clients
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-sm text-gray-400">
            © {currentYear} RendezVousPro. Tous droits réservés.
          </div>
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link to="/conditions-utilisation" className="text-sm text-gray-400 hover:text-white transition-colors">
