  ...
  return (
    <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {dayAvailability.isAvailable && (
                    ...
                    >
                      ...
                      <DialogContent>
                        <DialogHeader>
                          <DialogTitle>Ajouter un créneau - {day.label}</DialogTitle>
                          <DialogDescription>
                            Définissez l'heure de début et de fin pour ce nouveau créneau.
                          </DialogDescription>
                        </DialogHeader>
      ...
      <Alert>
        ...
        <AlertDescription>
          <strong>Conseil :</strong> Veillez à laisser suffisamment de temps entre 
          vos rendez-vous pour vous déplacer et préparer vos interventions.
        </AlertDescription>
      </Alert>
    </div>
  );
